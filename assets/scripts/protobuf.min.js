  ...
  })(
    {
        ...
        function (t, i, n) {
          ...
          n.encode = function (t, i, n) {
            ...
            return (
              ...
              e
                ? (o &&
                    e.push(String.fromCharCode.apply(String, s.slice(0, o))),
                  e.join(""))
        ...
        function (t, i, n) {
          ...
          function e(t, i) {
            (r.test(t) ||
              ...
              (i = {
                nested: { google: { nested: { protobuf: { nested: i } } } },
              })),
              (e[t] = i));
          }
          (e("any", {
      ...
      18: [
        function (t, i, n) {
          ...
          function e() {
            (r.util.p(),
              r.Writer.p(r.BufferWriter),
              r.Reader.p(r.BufferReader));
          }
          ((r.build = "minimal"),
            (r.Writer = t(42)),
            (r.BufferWriter = t(43)),
        ...
        function (t, i, n) {
          ...
          ((c.fromJSON = function (t, i) {
            ...
            (c.prototype.lookup = function (t, i, n) {
              ...
              if ((e = this.k(t, r)) && (!i || ~i.indexOf(e.constructor)))
                return e;
              if (!n)
                for (var s = this; s.parent; ) {
                  if (
                    (e = s.parent.k(t, r)) &&
                    (!i || ~i.indexOf(e.constructor))
                  )
                    return e;
                  s = s.parent;
                }
            ...
            (c.prototype.k = function (t, i) {
              if (Object.prototype.hasOwnProperty.call(this.b, i))
                return this.b[i];
              var n = this.get(t[0]),
                r = null;
              if (n)
        ...
        function (t, i, n) {
          ...
          (Object.defineProperties(h.prototype, {
            ...
            (h.prototype.resolve = function () {
              return (
                this.resolved ||
                  (this.root instanceof e && (this.resolved = !0)),
                this
              );
            }),
      ...
      26: [
        function (t, i, n) {
          (((i.exports = nt).filename = null),
            (nt.defaults = { keepCase: !1 }));
          var $ = t(34),
            F = t(29),
            P = t(35),
            R = t(16),
                      ...
                      x(null, function (t) {
                        switch (t) {
                          ...
                          case "optional":
                            I(
                              s,
                              "proto3" === w ? "proto3_optional" : "optional",
                              e,
                            );
                            break;
                          default:
                    ...
                    x(o, function (t) {
                      switch (t) {
                        ...
                        case "repeated":
                          ...
                          break;
                        case "optional":
                          I(o, "proto3" === w ? "proto3_optional" : "optional");
                          break;
                        case "message":
                          S(o);
                          break;
                ...
                switch (t) {
                  ...
                  default:
                    ...
                    return (
                      ...
                      void i.add(n, r, e.comment, e.parsedOptions || e.options)
                    );
                }
              }),
                t.add(s),
                  ...
                  if (
                    ...
                    if (r.imports)
                      for (; e < r.imports.length; ++e)
                        (n =
                          h(r.imports[e]) || o.resolvePath(t, r.imports[e])) &&
                          c(n);
                    if (r.weakImports)
              ...
              return o.rpcImpl(
                ...
                function (t, i) {
                  ...
                  if (!(i instanceof r))
                    try {
                      i =
                        r[o.responseDelimited ? "decodeDelimited" : "decode"](
                          i,
                        );
                    } catch (t) {
        ...
        function (t, i, n) {
          i.exports = function (t) {
            ...
            for (var e = 0; e < t.fieldsArray.length; ++e) {
              ...
              (o.optional &&
                i("if(%s!=null&&m.hasOwnProperty(%j)){", u, o.name),
                o.map
                  ? (i("if(!util.isObject(%s))", u)("return%j", h(o, "object"))(
                    ...
                    a(i, o, e, u + "[k[i]]")("}"))
                  : o.repeated
                    ? (i("if(!Array.isArray(%s))", u)(
                        "return%j",
                        h(o, "array"),
                      )("for(var i=0;i<%s.length;++i){", u),
                      a(i, o, e, u + "[i]")("}"))
                    : (o.partOf &&
      ...
      42: [
        function (t, i, n) {
          ...
          ((c.create = l()),
            ...
            ((p.prototype = Object.create(f.prototype)).fn = function (
              t,
              i,
              n,
            ) {
        ...
        function (t, i, n) {
          ...
          ((s.p = function () {
            ...
            (s.prototype.bytes = function (t) {
              ...
              return (
                this.uint32(i),
                i && this.M(s.writeBytesBuffer, i, t),
                this
              );
            }),
